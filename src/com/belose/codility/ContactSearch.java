...
public class ContactSearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                solution(new String[]{"pim", "pom"}, new String[]{"999999999", "777888999"},
                        "88999"));

        System.out.println(
                solution(new String[]{"sander", "amy", "ann", "michael"}, new String[]{"123456789", "234567890", "789123456", "123123123"},
                        "1"));
